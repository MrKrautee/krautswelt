...
function setUpAjaxForm(form_selector, url, options){
  var AjaxForm = {
    ...
    setUpTypingValidation: function(){
      ...
      $(this.selector+" :input").each(function(){
        if($(this).attr("type") != "submit" && $(this).attr("type") != "hidden"){
          ...
          $(this).focusout(function(e){return self.validateSingleInput(e.target);});
        }
      });
    },
	...
	// only one argument, options
	if(typeof form_selector === 'object' && typeof url === 'undefined' && typeof options === 'undefined'){
